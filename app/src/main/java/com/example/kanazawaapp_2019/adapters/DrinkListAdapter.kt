...
import kotlinx.android.synthetic.main.drink_list_row.*
import java.text.FieldPosition
import java.util.*
import kotlin.collections.ArrayList

class DrinkListAdapter(private var context: Context, private var items: ArrayList<DrinkModel>) :BaseAdapter(){
